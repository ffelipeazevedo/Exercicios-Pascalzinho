...
type  										//cria novos tipos de informaçao
      ...
      car:INTEGER;                 						//--           32
			...
			som,clg,clc,ccl,FALTA,TUR:INTEGER;     	//6*32 --     192
     end;                          						//tamanho ==> 880 bits
     ...
     vetor=array[1..3000] of cc; 	// tipo vetor vetor de 3000 posições com duas informaçoes (integer e string[35]) 
		 															//por posição
