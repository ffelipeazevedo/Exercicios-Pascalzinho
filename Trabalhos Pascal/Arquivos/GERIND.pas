...
{FUP QUE A PARTIR DO ARQUIVO cand.txt GERE UM ARQUIVO PARA ACESSO INDEXADO cand.IND
 ...
 notas(6)=integer, soma das notas=integer, classif geral, classif cargo, cargo de classif, FALTA e 
 TURMA=todos integer
															 880 BITS no total
...
VAR ARQIN:TEXT;
    ...
    A,B,E,NUM:INTEGER;
Begin
  ASSIGN(ARQIN,'C:\Users\ffern\OneDrive\Escritorio\Trabalhos Pascal\CAND.TXT');
  RESET(ARQIN);
  ASSIGN(ARQD,'C:\Users\ffern\OneDrive\Escritorio\Trabalhos Pascal\CAND.IND');
  REWRITE(ARQD);
...
//    SEEK(ARQD,NUM-1); //a primeira p.f. é o numero 0.
    ...
    SEEK(ARQD,A); //<<<<<<COMPARE COM O QUE GERA CAND.DIR (ARQDIR)
